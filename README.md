...
^ blog post with a bunch of comments from frustrated developers similar to myself

documentation of the specific endpoint which has been deprecated:
...
Functionality:
note: all functionality prior to pressing the "Give Recommendations" button works perfectly, but I will describe it nonetheless.
